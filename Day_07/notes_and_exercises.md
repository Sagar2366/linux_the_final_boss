...
- [Day 07: Users, Groups & Permissions](#day-07-users-groups-&-permissions)
  - [Learning Objectives](#learning-objectives)
  - [Sample Environment Setup](#sample-environment-setup)
- [Create test users and groups (if not existing)](#create-test-users-and-groups-if-not-existing)
- [Create a test file and directory](#create-a-test-file-and-directory)
- [Enable ACLs on filesystem if needed (e.g., for ext4)](#enable-acls-on-filesystem-if-needed-e.g.-for-ext4)
- [View initial state](#view-initial-state)
  - [Notes](#notes)
    - [Top 8 User & Permission Management Commands](#top-8-user-&-permission-management-commands)
    - [User Concepts & Management](#user-concepts-&-management)
- [View files (as root for shadow)](#view-files-as-root-for-shadow)
- [Create user interactively (recommended for beginners)](#create-user-interactively-recommended-for-beginners)
- [Create user non-interactively](#create-user-non-interactively)
- [Set/change password](#setchange-password)
- [Modify user](#modify-user)
- [Delete user](#delete-user)
- [View user info](#view-user-info)
    - [Group Concepts & Management](#group-concepts-&-management)
- [Create/modify group](#createmodify-group)
- [Manage members](#manage-members)
- [Delete group (must be empty)](#delete-group-must-be-empty)
- [View groups](#view-groups)
    - [File Ownership & Permissions](#file-ownership-&-permissions)
      - [Numeric Mode Combinations](#numeric-mode-combinations)
      - [Symbolic Mode Examples](#symbolic-mode-examples)
      - [Access Control Lists (ACLs)](#access-control-lists-acls)
    - [Special Permissions](#special-permissions)
- [Set special perms](#set-special-perms)
- [Numeric: 4755 for SUID+755, 2755 for SGID+755, 1755 for Sticky+755](#numeric-4755-for-suid+755-2755-for-sgid+755-1755-for-sticky+755)
- [View (s/t appear in ls -l)](#view-st-appear-in-ls--l)
- [Examples:](#examples)
- [SUID: /usr/bin/passwd (users change own password as root)](#suid-usrbinpasswd-users-change-own-password-as-root)
- [SGID: /usr/bin/wall (broadcast as group)](#sgid-usrbinwall-broadcast-as-group)
- [Sticky: /tmp (users can't delete others' files)](#sticky-tmp-users-can't-delete-others'-files)
    - [Account Security & Switching](#account-security-&-switching)
...
- [Create user, add to group, set perms on shared dir](#create-user-add-to-group-set-perms-on-shared-dir)
- [Audit users in group and their files](#audit-users-in-group-and-their-files)
- [Bulk lock expired accounts (example with awk)](#bulk-lock-expired-accounts-example-with-awk)
- [Find and remove orphaned SUID files (careful!)](#find-and-remove-orphaned-suid-files-careful!)
- [Set ACL for team on shared dir, view inheritance](#set-acl-for-team-on-shared-dir-view-inheritance)
